...
```bash
digitaldollard start --json-rpc.enable
```
...
```bash
digitaldollard start --json-rpc.enable-indexer 
```
...
```bash
digitaldollard index-eth-tx backward
```
...
```bash
digitaldollard index-eth-tx forward
```
