...
```bash
$ digitaldollard keys add dev0-restored --recover
...
```bash
digitaldollard keys export dev0
...
```bash
digitaldollard keys unsafe-export-eth-key dev0 > dev0.export
...
```bash
$ digitaldollard keys import dev0-imported ./dev0.export
Enter passphrase to decrypt your key:
```
...
```
$ digitaldollard keys unsafe-import-eth-key dev0-imported ./dev0.export
