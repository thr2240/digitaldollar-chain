...
Find below a list of  `digitaldollard` commands added with the  `x/revenue` module. You can obtain the full list by using the `digitaldollard -h` command. A CLI command can look like this:

```bash
digitaldollard query revenue params
```
